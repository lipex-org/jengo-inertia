            ...
            <div className="min-h-screen bg-base-200 text-base-content relative overflow-hidden flex flex-col">
                ...
                <nav className="relative z-10 px-6 py-8 flex justify-between items-center max-w-7xl mx-auto w-full">
                    ...
                    <div className="flex items-center gap-6">
                        {user ? (
                            <Link href="/dashboard" className="btn btn-primary btn-sm px-5">
                                Dashboard
                            </Link>
                        ) : (
                            <>
                                <Link href="/login" className="link link-hover text-sm font-bold text-base-content/85 hover:text-primary transition-colors">
                                    Log in
                                </Link>
                                <Link href="/register" className="btn btn-primary btn-sm px-5">
                                    Get Started
                                </Link>
                            </>
                        )}
                ...
                <main className="relative z-10 grow flex flex-col items-center justify-center px-6 text-center">
                    ...
                    <h1 className="text-6xl md:text-8xl font-black text-base-content tracking-tight mb-6 leading-none">
                        Build faster with <span class="text-transparent bg-clip-text bg-gradient-to-tr from-primary to-secondary">Jengo</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                        <Link href="/register" className="btn btn-primary btn-lg px-10 shadow-md">
                            Start Building
                        </Link>
                        <a href="https://github.com/jengophp" target="_blank" rel="noreferrer"
                            className="btn btn-outline btn-lg px-10 border-base-300 text-base-content hover:bg-base-300 transition-all flex items-center gap-2">
                            Documentation
                    ...
                    <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl w-full text-left">
                        ...
                        <div className="card bg-base-100 border border-base-300/50 p-8 shadow-md">
                            ...
                            <h3 className="text-lg font-bold text-base-content mb-2">Shield Security</h3>
                            <p className="text-base-content/70 text-sm">Robust authentication and authorization built directly into the core using CI Shield.</p>
                        </div>
